...
## UHL Systems Branding Kit Standard

Wenn ein Logo für UHL Systems erstellt wird, immer ALLE folgenden Varianten liefern:

### Output-Varianten (Pflicht)
| Datei | Format | Zweck | Hintergrund |
|-------|--------|-------|-------------|
| `logo-primary.svg` | SVG | Website Header, Standard | Transparent |
| `logo-dark-bg.svg` | SVG | Dunkle Hintergründe | #0a0a0a |
| `logo-light-bg.svg` | SVG | Helle Hintergründe | #ffffff |
| `logo-inverted.svg` | SVG | Gegen-Farb-Version | Invertiert |
| `favicon.svg` | SVG | Browser Tab, App Icon | Transparent |
| `icon-only.svg` | SVG | Social Media Avatar, kleine Icons | Transparent |
| `instagram-logo.svg` | 1:1 SVG | Instagram Profil, Posts | #0a0a0a |
| `linkedin-banner.svg` | 3:1 SVG | LinkedIn Header Banner | #0a0a0a |
| `pdf-cover-logo.svg` | SVG | PDF/Dokument Cover | Transparent |

### SVG Qualitätsregeln
- Text IMMER als `<path>` einbetten (kein font-family das externe Fonts braucht)
- Oder: Google Fonts via `<defs><style>@import url(...)</style></defs>` einbetten
- viewBox immer gesetzt, width/height als Attribute
- Gruppen mit semantischen IDs: `id="logo-icon"`, `id="logo-text"`, `id="logo-tagline"`
- Kein hardcoded px - relative Koordinaten wo möglich
- Alle Pfade geschlossen und optimiert
- Teste bei 16px (Favicon) AND 500px (Print)

### Brand Colors
- Background Dark: `#0a0a0a`
- Background Light: `#ffffff`  
- Primary Text: `#ffffff` (auf dark) / `#0a0a0a` (auf light)
- Accent Neon-Gelb: `#e8ff00`
- Accent Neon-Grün: `#00ff88`
- Muted: `#888888`
