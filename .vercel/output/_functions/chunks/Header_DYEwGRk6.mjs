...
import 'piccolore';
import { w as createRenderInstruction, r as renderTemplate, x as defineScriptVars, h as addAttribute, u as unescapeHTML, m as maybeRenderHead, s as spreadAttributes, y as renderSlot, l as renderComponent } from './entrypoint_f67E6snO.mjs';
import 'clsx';
...
const $$HeaderLink = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(href, "href")}${addAttribute([
    ...
    isActive ? "text-accent font-medium border-b border-accent pb-0.5" : "text-muted hover:text-text",
    className
